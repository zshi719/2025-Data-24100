...
| 2: Docker, Make and Git | <ul><li>Docker</li><li>Make</li><li>Git</li><li>Environments</li></ul> | <ul><li>[Project Part 0 Due](./project_assignments/part_0.md)</li><li>Quiz \#1</li></ul> | <ul><li>[Lesson Plan](./lesson_plan/week_2.md)</li></ul> |
