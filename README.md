...
| 4: Flask & Code Quality | <ul><li>Advanced Requests</li><li>Organizing code</li><li>DRY</li><li>Separation of Concerns</li></ul> | <ul><li>[Project Part 2 Due](./project_assignments/part_2.md)</li><li>[Quiz 3A](./quiz/quiz3A.pdf)/[Quiz 3B](./quiz/quiz3B.pdf)</li><li>[Answer Key](./quiz/quiz3AK.md)</li></ul>  | <ul><li>[Lesson Plan](./lesson_plan/week_4.md)</li></ul> |
| 5: SQLite & Management Commands | <ul><li>SQLite</li><li>Management Commands</li><li>CRUD</li><li>POST Requests</li></ul> | <ul><li>[Project Part 3 Due](./project_assignments/part_3.md)</li><li>Quiz \#4</li></ul>  | <ul><li>[Lesson Plan](./lesson_plan/week_5.md)</li></ul> |
