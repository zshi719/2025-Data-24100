...
| 7: Adding Features | <ul><li>Logging in Python</li><li>Autodocs with MkDocs</li></ul> | <ul><li>[Project Part 5 Due](./project_assignments/part_5.md)</li><li>Quiz \#6</li></ul>  | <ul><li>[Lesson Plan](./lesson_plan/week_7.md)</li></ul> |
