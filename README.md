...
| 6: Static Analysis, CRUD & Logging | <ul><li>Static Analysis</li><li>Ruff & Pre-commit</li><li>More CRUD</li><li>Logging</li></ul> | <ul><li>[Project Part 4 Due](./project_assignments/part_4.md)</li><li>Quiz \#5</li></ul>  | <ul><li>[Lesson Plan](./lesson_plan/week_6.md)</li></ul> |
