...
| 6: Data Pipeline \#2 | <ul><li>SQLite</li><li>CRUD</li></ul> |  <ul><li>[Project Part IV Due](./project_assignments/part_4.md)</li></ul> | <ul><li>[Lesson Plan](./lesson_plan/week_6.md)</li></ul>
