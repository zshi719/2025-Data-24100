...
## Part V: Linting and Documentation
...
Your code must conform to all the requirements of [Part IV](./part_4.md) and there does not need to be any changes to the API, the goal is to get your code in a good space before we begin our next big addition.
