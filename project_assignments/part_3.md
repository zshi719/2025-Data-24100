...
**IMPORTANT NOTE**  The code will be evaluated based on the code quality principles that we mentioned in class: DRY, Separation of Concerns and having proper abstraction. File names should align with their content and file structures should be appropriate. 
...
- We will verify that endpoints work and generate the correct response for all data and years.
...
- The codes and routes need to be _performant_. After the flask server starts, nothing should take more than a few seconds to respond.
