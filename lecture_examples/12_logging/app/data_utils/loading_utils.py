...
def load_data_pandas():
    ...
    Reads player statistics from CSV and filters for the current season,
    returning only player name, college and team information.
    """
...
def load_data():
    ...
    Returns:
        DataFrame: Player statistics including ID, name, college and team.
    """
...
def rm_db(db_path=None):
    ...
    Args:
        db_path (str, optional): Path to database. Defaults to DB_PATH.
    """
    if not db_path:
        db_path = DB_PATH
